...
module Brevo
  class UpdateEmailCampaign
    ...
    def hash
      [tag, sender, name, html_content, html_url, scheduled_at, subject, preview_text, reply_to, to_field, recipients, attachment_url, inline_image_activation, mirror_active, recurring, footer, header, utm_campaign, utm_source, utm_medium, utm_id, params, send_at_best_time, ab_testing, subject_a, subject_b, split_rule, winner_criteria, winner_delay, ip_warmup_enable, initial_quota, increase_rate, unsubscription_page_id, update_form_id, email_expiration_date].hash
    end
